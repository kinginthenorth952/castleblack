...
export const INITIAL_CURRENCY_ACCOUNTS: CurrencyAccount[] = [
  {
    ...
    accountTitle: 'MUMTAZ MAI / SIKKA POULTRY FARM',
  ...
  },
  {
    ...
    accountTitle: 'SIKKA POULTRY FARM OFFICIAL',
  ...
  },
  {
    ...
    accountTitle: 'SIKKA POULTRY FARM FINANCIALS',
  ...
  },
  {
    ...
    accountTitle: 'SIKKA POULTRY TREASURY',
...
export const INITIAL_TASKS_REWARDS: TaskReward[] = [
  {
    ...
    rewardAmount: 60,
    taskType: 'whatsapp',
    linkUrl: 'https://chat.whatsapp.com/sikkapoultryfarmofficial',
    totalCompletions: 0,
    status: 'active'
  },
  {
    ...
    rewardAmount: 50,
    taskType: 'telegram',
    linkUrl: 'https://t.me/sikkapoultryfarm_official',
    totalCompletions: 0,
    status: 'active'
  },
  {
    ...
    rewardAmount: 75,
    taskType: 'youtube',
    linkUrl: 'https://youtube.com/@sikkapoultryfarm',
    totalCompletions: 0,
    status: 'active'
  },
  {
